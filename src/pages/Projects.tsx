...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'A full-featured e-commerce platform with product management, shopping cart, user authentication, and payment integration.',
      image: 'https://images.pexels.com/photos/1181671/pexels-photo-1181671.jpeg?auto=compress&cs=tinysrgb&w=800',
      technologies: ['React', 'Node.js', 'Express', 'MongoDB', 'Stripe'],
      category: 'fullstack',
      liveUrl: 'https://github.com/roshaldsouza/ecommerce-platform',
      githubUrl: 'https://github.com/roshaldsouza/ecommerce-platform',
    },
    {
      id: 6,
      title: 'Task Management System',
      description: 'A collaborative task management application with team features, project tracking, and real-time notifications.',
      image: 'https://images.pexels.com/photos/265087/pexels-photo-265087.jpeg?auto=compress&cs=tinysrgb&w=800',
      technologies: ['React', 'Node.js', 'Socket.io', 'MongoDB'],
      category: 'fullstack',
      liveUrl: 'https://github.com/roshaldsouza/task-management',
      githubUrl: 'https://github.com/roshaldsouza/task-management',
    },
  ];
